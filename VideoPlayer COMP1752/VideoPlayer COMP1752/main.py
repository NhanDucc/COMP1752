...
class CheckVideos():                    # Create the CheckVideos class
    def __init__(self, window):         # Constructor method
        ...
        enter_lbl = tk.Label(window, text="Choose Video Name")  # Create a label widget with the text "Choose Video Name"
        enter_lbl.grid(row=0, column=1, padx=10, pady=10)       # Place this label widget in the window
...
class FilterVideos():                       # Create the FilterVideos class
    def __init__(self, window):             # Constructor method
        ...
        selected_option = tk.StringVar()                                                                                            # Create a StringVar object to store the selected option
        director_names = ["Fred Quimby", "Blake Edwards", "Michael Curtiz", "Robert Wise", "Victor Fleming"]                        # Create a list of director names
        self.director_combo_box = ttk.Combobox(window, textvariable=selected_option, values=director_names)                         # Create a Combobox widget with the list of director names
    ...
    def filter_video_clicked(self):                                                                                                                 # Method to handle the "Filter" button click event
        ...
        key = lib.get_key_by_director(director)                                                                                                     # Get the key of the selected video
        ...
        self.status_lbl.configure(text="Filter button was clicked!")                                                                                # Update status label text
...
# Create a spacer tab
spacer_1 = ttk.Frame(tab_control)                  # Create a frame widget
tab_control.add(spacer_1, text=" ")                # Add the frame widget to the tab control
tab_control.tab(spacer_1, state='disabled')        # Disable the spacer tab
...
# Create a spacer tab
spacer_2 = ttk.Frame(tab_control)               # Create a frame widget
tab_control.add(spacer_2, text=" ")             # Add the frame widget to the tab control
tab_control.tab(spacer_2, state='disabled')     # Disable the spacer tab
...
# Create a spacer tab
spacer_3 = ttk.Frame(tab_control)               # Create a frame widget
