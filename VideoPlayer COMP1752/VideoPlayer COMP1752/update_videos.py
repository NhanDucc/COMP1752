...
class VideoManager:                             # Create the VideoManager class
    def __init__(self, name_combo_box, lib):    # Constructor method
        self.name_combo_box = name_combo_box    # Store the name_combo_box in an instance variable
        self.lib = lib                          # Store the lib in an instance variable
    
    def get_key(self):                      # Method to get the key of the selected video
...
class UpdateVideos():                   # Create the UpdateVideos class
    def __init__(self, window):         # Constructor method
        ...
        self.manager = VideoManager(self.name_combo_box, lib)   # Create a VideoManager object
    ...
    def search_video_clicked(self):                                                         # Method to handle the "Search" button click event
        name = self.name_combo_box.get()                                                    # Get the selected video name
        key = self.manager.get_key()                                                        # Get the key of the selected video
    ...
    def back_clicked(self):         # Method to handle the "Back" button click event
        fonts.configure()           # Re-apply the font configuration
